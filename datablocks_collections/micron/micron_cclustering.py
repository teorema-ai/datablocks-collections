...
class ZSConsensusClustering:
    """
      ...
      Args:
        ...
        * L -> smallest number of clusters to try [lo]
        * K -> biggest number of clusters to try [hi]
        * H -> number of resamplings for each cluster number[n_reps]
        * resample_proportion -> percentage to sample [p_sample]
    ...
    def __init__(self, cluster, *, lo=1, hi, n_reps=300, p_sample=0.8):
        L = lo
        K = hi
        H = n_reps
        resample_proportion = p_sample
